...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        next.setBounds(1200,650,100,30);
        ...
        submit.setBounds(1200,400,100,30);
    ...
    public void paint(Graphics g){
        ...
        if(timer>0){
            g.drawString(time, 1100, 580);
        }
        else{
            g.drawString("Time out",1100,580);
        }
        timer--;
        try{
            Thread.sleep(1000);
        ...
        if(ans_given==1){
            ...
            if(count==9){
                if(optiongroup.getSelection()==null){
                    ...
                    user_ans[count][0] = optiongroup.getSelection().getActionCommand();
                }
